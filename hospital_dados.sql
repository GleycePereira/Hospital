CREATE DATABASE IF NOT EXISTS hospital_dados;
USE hospital_dados;
...
-- Especialidade
INSERT INTO `hospital_dados`.`especialidade` (`nome_especialidade`) VALUES
("Clínico geral"),
("Gastroenterologia"),
("Pediatria"),
("Dermatologia"),
...
-- Medico
INSERT INTO `hospital_dados`.`medico`(`nome_med`,`sexo`,`CPF`,`CRM`,`data_nasc`,`id_med_espec`) VALUES
...
-- Convenio
INSERT INTO `hospital_dados`.`convenio`(`nome_convenio`,`CNPJ`)VALUES
...
-- Responsavel
INSERT INTO `hospital_dados`.`responsavel`(`nome_responsavel`,`CPF`,`parentesco`) VALUES
...
-- Paciente 
INSERT INTO `hospital_dados`.`paciente`(`nome_paci`,`sexo`,`RG`,`CPF`,`data_nasc`,`telefone`,`email`,`endereco`,`id_paci_conv`,`id_responsavel`) VALUES
...
-- CONSULTA
INSERT INTO `hospital_dados`.`consulta`(`data_consulta`, `id_med`, `id_paci`, `hora`, `valor`) VALUES 
...
-- Receita
INSERT INTO `hospital_dados`.`receita`(`medicamento`,`id_cMedi`,`id_pMedi`,`id_mMedi`)VALUES
...
-- Tipo quarto
INSERT INTO `hospital_dados`.`tipo_quarto`(`descricao`,`valor_diaria`)VALUES
("Enfermaria", 100),
("Quartos duplos", 120),
("Apartamento", 180);

-- Quarto
INSERT INTO `hospital_dados`.`quarto`(`numero_quarto`,`id_tipo`)VALUES
(33, 1),
(35, 2),
(52, 3);

-- Enfermeiro
INSERT INTO `hospital_dados`.`enfermeiro`(`nome_enfermeiro`,`CPF`,`COREN`)VALUES
...
-- Internacao
INSERT INTO `hospital_dados`.`internacao`(`procedimento`,`data_entrada`,`data_prev_alta`,`data_alta`,`id_pacIn`,`id_medIn`,`id_quartoIn`,`id_enferUm`,`id_enferDois`)
VALUES
